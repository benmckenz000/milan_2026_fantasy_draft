...
def get_medal_data():
    ...
    return {
        "Norway": {"gold": 12, "silver": 7, "bronze": 7},
        "South Korea": {"gold": 1, "silver": 2, "bronze": 2},
        "Italy": {"gold": 8, "silver": 4, "bronze": 10},
        "Germany": {"gold": 4, "silver": 5, "bronze": 4},
...
def update_leaderboard():
    ...
    sheet.clear()
    sheet.append_row(["Rank", "Name", "Total", "Gold", "Silver", "Bronze", "Breakdown"])
    ...
    for name, countries in draft.items():
        ...
        for c in countries:
            ...
            detail_list.append(f"{c}: {m['gold']}G")
        
        total = g + s + b
        final_list.append([name, total, g, s, b, " | ".join(detail_list)])
