...
## Overview
This project was developed to automate the scoring and reporting for a 2026 Winter Olympics Fantasy Draft. This pipeline scrapes the real-time medal standings from Wikipedia, calculates each participant's total medal count across their two countries, ranks the leaderboard, and pushes the results to a live Google Sheet every hour.
